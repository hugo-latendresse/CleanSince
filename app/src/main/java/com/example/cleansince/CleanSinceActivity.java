package com.example.cleansince;
...
public class CleanSinceActivity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (!isFinishing()) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(CleanSinceActivity.this);
                            ...
                            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if (!isFinishing()) {
                                        AlertDialog.Builder builder = new AlertDialog.Builder(CleanSinceActivity.this);
                                        final EditText input = new EditText(CleanSinceActivity.this);
